 ...
 * LMD-18-01-2014
 */
public class At_Create_Report extends SuperTestNG
{
	@Test
	public void testAt_Create_Report() throws InterruptedException
	{
		...
		Thread.sleep(5000);
		for(int k=0;k<=Generic.XLRow(XLPath, Sheet);k++)
		{
			...
			for(int i=0;i<=Generic.XLRow(XLPath, Sheet);i++)
			{
				...
				{
					//driver.findElement(By.xpath("//div[label[text()='Selected Staff:']]//img")).click(); not working on local copy
					driver.findElement(By.xpath("//tr[td[label[text()='Selected Staff:']]]/td[1]/input")).click();
					//driver.findElement(By.xpath("//a[span[contains(@title,'"+Generic.XLCellValue(XLPath, Sheet, i, 3)+"')]]/span[1]")).click();
